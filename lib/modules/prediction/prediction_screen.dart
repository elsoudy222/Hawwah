  ...
  Widget build(BuildContext context) {
    return BlocConsumer<HomeCubit, HomeStates>(
      ...
      builder: (context, state) {
        ...
        TextEditingController concavity_meanController =
        ...
        TextEditingController smoothness_worstController =
            TextEditingController();
        TextEditingController concavity_worstController =
            TextEditingController();
        TextEditingController symmetry_worstController =
            TextEditingController();
